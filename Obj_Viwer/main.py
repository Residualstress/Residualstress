...
fidr = "resource/"
fobj = input("Please enter the model name (i.e., garg/mickey/sphere):") + ".obj"
# fobj = "garg.obj"
    ...
    while 1:
        ...
        for e in pygame.event.get():
            if e.type == QUIT:
                ...
                if e.button == 4:  # 4，5表示鼠标滚轮的滚动
                    zpos = max(1, zpos - 1)
                elif e.button == 5:
                    zpos += 1
                elif e.button == 1:  # 1表示左键
                    rotate = True
                elif e.button == 3:  # 3表示右键
                    move = True
